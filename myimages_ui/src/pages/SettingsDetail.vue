					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateSettings()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Settingss = true">Add</base-button>
								              <modal :show.sync="modal2Settingss">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Settings Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="SettingsId" type="text" placeholder="Enter SettingsId" v-model="settingsDetails.settingsId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">User Profile Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="UserProfileId" type="text" placeholder="Enter UserProfileId" v-model="settingsDetails.userProfileId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Theme</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Theme" type="text" placeholder="Enter Theme" v-model="settingsDetails.theme"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Notification Enabled</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="NotificationEnabled" type="text" placeholder="Enter NotificationEnabled" v-model="settingsDetails.notificationEnabled"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateSettings() {
      ...
      const jsonData = JSON.stringify(this.settingsDetails);
      const res = await SettingsService.update(jsonData);
...
//        this.getAllSettingss();
    ...
    async getSettingsDetails() {
      try {
			let response = await SettingsService.get(this.settingsId);
