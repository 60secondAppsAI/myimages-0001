					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateHistory()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Historys = true">Add</base-button>
								              <modal :show.sync="modal2Historys">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">History Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="HistoryId" type="text" placeholder="Enter HistoryId" v-model="historyDetails.historyId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">User Profile Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="UserProfileId" type="text" placeholder="Enter UserProfileId" v-model="historyDetails.userProfileId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Image Action</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ImageAction" type="text" placeholder="Enter ImageAction" v-model="historyDetails.imageAction"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Action Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="historyDetails.actionDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateHistory() {
      ...
      const jsonData = JSON.stringify(this.historyDetails);
      const res = await HistoryService.update(jsonData);
...
//        this.getAllHistorys();
    ...
    async getHistoryDetails() {
      try {
			let response = await HistoryService.get(this.historyId);
