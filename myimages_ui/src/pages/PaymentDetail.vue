						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="SubscriptionId" type="text" placeholder="Enter SubscriptionId" v-model="paymentToAdd.subscriptionId"></base-input>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Subscription Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="SubscriptionId" type="text" placeholder="Enter SubscriptionId" v-model="paymentDetails.subscriptionId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
