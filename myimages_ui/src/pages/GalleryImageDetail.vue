					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateGalleryImage()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2GalleryImages = true">Add</base-button>
								              <modal :show.sync="modal2GalleryImages">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Gallery Image Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="GalleryImageId" type="text" placeholder="Enter GalleryImageId" v-model="galleryImageDetails.galleryImageId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Gallery Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="GalleryId" type="text" placeholder="Enter GalleryId" v-model="galleryImageDetails.galleryId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Image Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ImageId" type="text" placeholder="Enter ImageId" v-model="galleryImageDetails.imageId"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async handleAddSubmitted() {
      this.modal2GalleryImages = false;
    ...
    async updateGalleryImage() {
      ...
      const jsonData = JSON.stringify(this.galleryImageDetails);
      const res = await GalleryImageService.update(jsonData);
...
//        this.getAllGalleryImages();
    ...
    async getGalleryImageDetails() {
      try {
			let response = await GalleryImageService.get(this.galleryImageId);
			this.galleryImageDetails = response.data;
